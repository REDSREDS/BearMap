...
public class TestRasterer {
    ...
    private static final String PARAMS_FILE = "src/main/resources/raster_params.txt";
    private static final String RESULTS_FILE = "src/main/resources/raster_results.txt";
