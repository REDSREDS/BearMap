...
public class TestRouter {
    private static final String PARAMS_FILE = "src/main/resources/path_params.txt";
    private static final String RESULTS_FILE = "src/main/resources/path_results.txt";
